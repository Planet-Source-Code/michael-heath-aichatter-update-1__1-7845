...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame fmTools 
      ...
      Begin VB.CommandButton cmdControl 
         ...
         Left            =   150
         TabIndex        =   11
         ToolTipText     =   "Toggles Michael's learning on/off.  Michael's Learning is on"
         Top             =   2370
         Width           =   1305
      End
      Begin VB.CommandButton cmdControl 
      ...
      Begin VB.CommandButton cmdControl 
         ...
         Left            =   150
         TabIndex        =   8
         ToolTipText     =   "View all the questions/statements Michael has available."
         Top             =   1110
         Width           =   1305
      End
      Begin VB.CommandButton cmdControl 
      ...
      Begin VB.CommandButton cmdControl 
         ...
         Left            =   150
         TabIndex        =   6
         ToolTipText     =   "Creates a new General DB File"
         Top             =   270
         Width           =   1305
      End
...
End If
'If KeyCode = 190 Then
'    MsgBox "Please do not use periods, it causes confusion in the dictionary"
'End If
'If KeyCode = 188 Then
'    MsgBox "Please do not use commas, it causes confusion in the dictionary"
'End If
'MsgBox KeyCode
