...
Intro
HowMnyQs
AILearn = True ' By default we want michael to prompt user for learning
...
Open DBFlag For Input As #2
    ...
    If AnsFound = False Then
        frmMain.txtChat.Text = frmMain.txtChat.Text & Chr(10) & strUser & ":> " & strQuestion
        frmMain.txtChat.Text = frmMain.txtChat.Text & Chr(10) & strName & ":> I guess I don't know what you said, could you rephrase it?"
